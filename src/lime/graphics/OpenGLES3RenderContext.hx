...
@:noCompletion private inline function get_VERTEX_PROGRAM_POINT_SIZE():Int {#if (js && html5) return 0; #else return this.VERTEX_PROGRAM_POINT_SIZE; #end
} // TODO

@:noCompletion private inline function get_POINT_SPRITE():Int {#if (js && html5) return 0; #else return this.POINT_SPRITE; #end
} // TODO
