...
abstract Int16Array(JSInt16Array) from JSInt16Array to JSInt16Array {
	...
	@:generic
	public inline function new<T>(?elements:Int, ?array:Array<T>, #if openfl ?vector:openfl.Vector<Int>, #end ?view:ArrayBufferView, ?buffer:ArrayBuffer, ?byteoffset:Int = 0, ?len:Null<Int>) {
		if (elements != null) {
	...
	public static inline function fromBytes(bytes:haxe.io.Bytes, ?byteOffset:Int = 0, ?len:Int):Int16Array {
		if (byteOffset == null)
			return new JSInt16Array(cast bytes.getData());
		if (len == null)
...
abstract Int16Array(ArrayBufferView) from ArrayBufferView to ArrayBufferView {
	...
	@:generic
	#end
	public inline function new<T>(?elements:Int, ?buffer:ArrayBuffer, ?array:Array<T>, #if openfl ?vector:openfl.Vector<Int>, #end ?view:ArrayBufferView, ?byteoffset:Int = 0, ?len:Null<Int>) {
		if (elements != null) {
