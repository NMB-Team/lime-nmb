...
class AssetsMacro {
	...
	macro public static function embedBytes():Array<Field> {
		...
		var superCall = Context.defined("html5") ? macro super(bytes.b.buffer) : Context.defined("hl") ? macro super(bytes.b, bytes.length) : macro super(bytes.length, bytes.b);
	...
	macro public static function embedImage():Array<Field> {
		...
		if (Context.defined("html5")) {
			definition = macro class Temp {
				...
				public function new(?buffer:lime.graphics.ImageBuffer, ?offsetX:Int, ?offsetY:Int, ?width:Int, ?height:Int, ?color:Null<Int>, ?type:lime.graphics.ImageType, ?onload:Dynamic = true) {
					super();
			...
			definition = macro class Temp {
				public function new(?buffer:lime.graphics.ImageBuffer, ?offsetX:Int, ?offsetY:Int, ?width:Int, ?height:Int, ?color:Null<Int>, ?type:lime.graphics.ImageType) {
					super();
