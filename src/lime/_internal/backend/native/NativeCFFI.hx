...
class NativeCFFI {
	...
	@:cffi private static function lime_image_data_util_threshold(image:Dynamic, sourceImage:Dynamic, sourceRect:Dynamic, destPoint:Dynamic, operation:Int, thresholdRG:Int, thresholdBA:Int, colorRG:Int, colorBA:Int, maskRG:Int, maskBA:Int,
		copySource:Bool):Int;
	...
	private static var lime_file_dialog_open_directory = new cpp.Callable<String -> String -> String -> cpp.Object>(cpp.Prime._loadPrime("lime", "lime_file_dialog_open_directory", "ssso", false));
	private static var lime_file_dialog_open_file = new cpp.Callable<String -> String -> String -> cpp.Object>(cpp.Prime._loadPrime("lime", "lime_file_dialog_open_file", "ssso", false));
	private static var lime_file_dialog_open_files = new cpp.Callable<String -> String -> String -> cpp.Object>(cpp.Prime._loadPrime("lime", "lime_file_dialog_open_files", "ssso", false));
	private static var lime_file_dialog_save_file = new cpp.Callable<String -> String -> String -> cpp.Object>(cpp.Prime._loadPrime("lime", "lime_file_dialog_save_file", "ssso", false));
	...
	private static var lime_image_data_util_copy_pixels = new cpp.Callable<cpp.Object -> cpp.Object -> cpp.Object -> cpp.Object -> cpp.Object -> cpp.Object -> Bool -> cpp.Void>(cpp.Prime._loadPrime("lime", "lime_image_data_util_copy_pixels",
		"oooooobv", false));
	...
	private static var lime_image_data_util_threshold = new cpp.Callable<cpp.Object -> cpp.Object -> cpp.Object -> cpp.Object -> Int -> Int -> Int -> Int -> Int -> Int -> Int -> Bool -> Int>(cpp.Prime._loadPrime("lime",
		"lime_image_data_util_threshold", "ooooiiiiiiibi", false));
	...
	private static var lime_joystick_get_num_trackballs = new cpp.Callable<Int -> Int>(cpp.Prime._loadPrime("lime", "lime_joystick_get_num_trackballs", "ii", false));
	...
	private static var lime_jpeg_decode_bytes = new cpp.Callable<cpp.Object -> Bool -> cpp.Object -> cpp.Object>(cpp.Prime._loadPrime("lime", "lime_jpeg_decode_bytes", "oboo", false));
	private static var lime_jpeg_decode_file = new cpp.Callable<String -> Bool -> cpp.Object -> cpp.Object>(cpp.Prime._loadPrime("lime", "lime_jpeg_decode_file", "sboo", false));
	...
	private static var lime_window_set_cursor_directly = new cpp.Callable<cpp.Object -> cpp.Object -> cpp.Void>(cpp.Prime._loadPrime("lime", "lime_window_set_cursor_directly", "oov", false));
	private static var lime_create_cursor_image = new cpp.Callable<cpp.Object -> Int -> Int -> cpp.Object>(cpp.Prime._loadPrime("lime", "lime_create_cursor_image", "oiio", false));
	...
	@:hlNative("lime", "hl_application_event_manager_register") private static function lime_application_event_manager_register(callback:Void -> Void, eventObject:ApplicationEventInfo):Void {}
	...
	@:hlNative("lime", "hl_clipboard_event_manager_register") private static function lime_clipboard_event_manager_register(callback:Void -> Void, eventObject:ClipboardEventInfo):Void {}
	...
	@:hlNative("lime", "hl_drop_event_manager_register") private static function lime_drop_event_manager_register(callback:Void -> Void, eventObject:DropEventInfo):Void {}

	@:hlNative("lime", "hl_file_dialog_open_directory") private static function lime_file_dialog_open_directory(title:String, filter:String, defaultPath:String):hl.Bytes {
		return null;
	}
	...
	@:hlNative("lime", "hl_file_dialog_open_files") private static function lime_file_dialog_open_files(title:String, filter:String, defaultPath:String):hl.NativeArray<hl.Bytes> {
		return null;
	}
	...
	@:hlNative("lime", "hl_file_watcher_add_directory") private static function lime_file_watcher_add_directory(handle:CFFIPointer, path:String, recursive:Bool):Int {
		return 0;
	}
	...
	@:hlNative("lime", "hl_font_get_glyph_indices") private static function lime_font_get_glyph_indices(handle:CFFIPointer, characters:String):hl.NativeArray<Int> {
		return null;
	}
	...
	@:hlNative("lime", "hl_font_render_glyphs") private static function lime_font_render_glyphs(handle:CFFIPointer, indices:hl.NativeArray<Int>, data:Bytes):Bytes {
		return null;
	}
	...
	@:hlNative("lime", "hl_gamepad_event_manager_register") private static function lime_gamepad_event_manager_register(callback:Void -> Void, eventObject:GamepadEventInfo):Void {}
	...
	@:hlNative("lime", "hl_image_data_util_color_transform") private static function lime_image_data_util_color_transform(image:Image, rect:Rectangle, colorMatrix:ArrayBufferView):Void {}

	// @:cffi private static function lime_image_data_util_copy_channel (image:Dynamic, sourceImage:Dynamic, sourceRect:Dynamic, destPoint:Dynamic, srcChannel:Int, destChannel:Int):Void;
	@:hlNative("lime", "hl_image_data_util_copy_channel") private static function lime_image_data_util_copy_channel(image:Image, sourceImage:Image, sourceRect:Rectangle, destPoint:Vector2, srcChannel:Int, destChannel:Int):Void {}
	...
	@:hlNative("lime", "hl_image_data_util_fill_rect") private static function lime_image_data_util_fill_rect(image:Image, rect:Rectangle, rg:Int, ba:Int):Void {}

	@:hlNative("lime", "hl_image_data_util_flood_fill") private static function lime_image_data_util_flood_fill(image:Image, x:Int, y:Int, rg:Int, ba:Int):Void {}

	@:hlNative("lime", "hl_image_data_util_get_pixels") private static function lime_image_data_util_get_pixels(image:Image, rect:Rectangle, format:Int, bytes:Bytes):Void {}

	// @:cffi private static function lime_image_data_util_merge (image:Dynamic, sourceImage:Dynamic, sourceRect:Dynamic, destPoint:Dynamic, redMultiplier:Int, greenMultiplier:Int, blueMultiplier:Int, alphaMultiplier:Int):Void;
	@:hlNative("lime", "hl_image_data_util_merge") private static function lime_image_data_util_merge(image:Image, sourceImage:Image, sourceRect:Rectangle, destPoint:Vector2, redMultiplier:Int, greenMultiplier:Int, blueMultiplier:Int,
	...
	@:hlNative("lime", "hl_image_data_util_resize") private static function lime_image_data_util_resize(image:Image, buffer:ImageBuffer, width:Int, height:Int):Void {}
	...
	// @:cffi private static function lime_image_data_util_set_pixels (image:Dynamic, rect:Dynamic, bytes:Dynamic, offset:Int, format:Int, endian:Int):Void;
	@:hlNative("lime", "hl_image_data_util_set_pixels") private static function lime_image_data_util_set_pixels(image:Image, rect:Rectangle, bytes:Bytes, offset:Int, format:Int, endian:Int):Void {}
	...
	@:hlNative("lime", "hl_image_data_util_threshold") private static function lime_image_data_util_threshold(image:Image, sourceImage:Image, sourceRect:Rectangle, destPoint:Vector2, operation:Int, thresholdRG:Int, thresholdBA:Int, colorRG:Int,
			colorBA:Int, maskRG:Int, maskBA:Int, copySource:Bool):Int {
		return 0;
	}
	...
	@:hlNative("lime", "hl_joystick_event_manager_register") private static function lime_joystick_event_manager_register(callback:Void -> Void, eventObject:JoystickEventInfo):Void {}
	...
	@:hlNative("lime", "hl_key_event_manager_register") private static function lime_key_event_manager_register(callback:Void -> Void, eventObject:KeyEventInfo):Void {}
	...
	@:hlNative("lime", "hl_mouse_event_manager_register") private static function lime_mouse_event_manager_register(callback:Void -> Void, eventObject:MouseEventInfo):Void {}
	...
	@:hlNative("lime", "hl_render_event_manager_register") private static function lime_render_event_manager_register(callback:Void -> Void, eventObject:RenderEventInfo):Void {}

	@:hlNative("lime", "hl_sensor_event_manager_register") private static function lime_sensor_event_manager_register(callback:Void -> Void, eventObject:SensorEventInfo):Void {}
	...
	@:hlNative("lime", "hl_text_event_manager_register") private static function lime_text_event_manager_register(callback:Void -> Void, eventObject:TextEventInfo):Void {}

	@:hlNative("lime", "hl_touch_event_manager_register") private static function lime_touch_event_manager_register(callback:Void -> Void, eventObject:TouchEventInfo):Void {}
	...
	@:hlNative("lime", "hl_window_create") private static function lime_window_create(application:CFFIPointer, width:Int, height:Int, flags:Int, title:String):CFFIPointer {
		return null;
	}
	...
	@:hlNative("lime", "hl_window_read_pixels") private static function lime_window_read_pixels(handle:CFFIPointer, rect:Rectangle, imageBuffer:ImageBuffer):Dynamic {
		return null;
	}
	...
	@:hlNative("lime", "hl_window_set_display_mode") private static function lime_window_set_display_mode(handle:CFFIPointer, displayMode:DisplayMode, result:DisplayMode):Void {}
	...
	@:hlNative("lime", "hl_window_event_manager_register") private static function lime_window_event_manager_register(callback:Void -> Void, eventObject:WindowEventInfo):Void {}
	...
	private static var lime_al_source3i = new cpp.Callable<cpp.Object -> Int -> cpp.Object -> Int -> Int -> cpp.Void>(cpp.Prime._loadPrime("lime", "lime_al_source3i", "oioiiv", false));
	...
	#if hl
	@:hlNative("lime", "hl_al_buffer_data") private static function lime_al_buffer_data(buffer:CFFIPointer, format:Int, data:ArrayBufferView, size:Int, freq:Int):Void {}

	@:hlNative("lime", "hl_al_buffer3f") private static function lime_al_buffer3f(buffer:CFFIPointer, param:Int, value1:hl.F32, value2:hl.F32, value3:hl.F32):Void {}
	...
	@:hlNative("lime", "hl_al_source_queue_buffers") private static function lime_al_source_queue_buffers(source:CFFIPointer, nb:Int, buffers:hl.NativeArray<CFFIPointer>):Void {}
	...
	@:hlNative("lime", "hl_al_source_unqueue_buffers") private static function lime_al_source_unqueue_buffers(source:CFFIPointer, nb:Int):hl.NativeArray<CFFIPointer> {
		return null;
	}

	@:hlNative("lime", "hl_al_source3f") private static function lime_al_source3f(source:CFFIPointer, param:Int, value1:hl.F32, value2:hl.F32, value3:hl.F32):Void {}
	...
	#if hl
	@:hlNative("lime", "hl_cairo_arc") private static function lime_cairo_arc(handle:CFFIPointer, xc:Float, yc:Float, radius:Float, angle1:Float, angle2:Float):Void {}

	@:hlNative("lime", "hl_cairo_arc_negative") private static function lime_cairo_arc_negative(handle:CFFIPointer, xc:Float, yc:Float, radius:Float, angle1:Float, angle2:Float):Void {}
	...
	@:hlNative("lime", "hl_cairo_clip_extents") private static function lime_cairo_clip_extents(handle:CFFIPointer, x1:Float, y1:Float, x2:Float, y2:Float):Void {}
	...
	@:hlNative("lime", "hl_cairo_curve_to") private static function lime_cairo_curve_to(handle:CFFIPointer, x1:Float, y1:Float, x2:Float, y2:Float, x3:Float, y3:Float):Void {}

	@:hlNative("lime", "hl_cairo_fill") private static function lime_cairo_fill(handle:CFFIPointer):Void {}

	@:hlNative("lime", "hl_cairo_fill_extents") private static function lime_cairo_fill_extents(handle:CFFIPointer, x1:Float, y1:Float, x2:Float, y2:Float):Void {}
	...
	@:hlNative("lime", "hl_cairo_mask_surface") private static function lime_cairo_mask_surface(handle:CFFIPointer, surface:CFFIPointer, x:Float, y:Float):Void {}
	...
	@:hlNative("lime", "hl_cairo_rectangle") private static function lime_cairo_rectangle(handle:CFFIPointer, x:Float, y:Float, width:Float, height:Float):Void {}

	@:hlNative("lime", "hl_cairo_rel_curve_to") private static function lime_cairo_rel_curve_to(handle:CFFIPointer, dx1:Float, dy1:Float, dx2:Float, dy2:Float, dx3:Float, dy3:Float):Void {}
	...
	@:hlNative("lime", "hl_cairo_set_source_rgba") private static function lime_cairo_set_source_rgba(handle:CFFIPointer, r:Float, g:Float, b:Float, a:Float):Void {}

	@:hlNative("lime", "hl_cairo_set_source_surface") private static function lime_cairo_set_source_surface(handle:CFFIPointer, surface:CFFIPointer, x:Float, y:Float):Void {}
	...
	@:hlNative("lime", "hl_cairo_stroke_extents") private static function lime_cairo_stroke_extents(handle:CFFIPointer, x1:Float, y1:Float, x2:Float, y2:Float):Void {}
	...
	@:hlNative("lime", "hl_cairo_font_options_set_hint_metrics") private static function lime_cairo_font_options_set_hint_metrics(handle:CFFIPointer, v:Int):Void {}
	...
	@:hlNative("lime", "hl_cairo_font_options_set_subpixel_order") private static function lime_cairo_font_options_set_subpixel_order(handle:CFFIPointer, v:Int):Void {}
	...
	@:hlNative("lime", "hl_cairo_image_surface_create_for_data") private static function lime_cairo_image_surface_create_for_data(data:Float, format:Int, width:Int, height:Int, stride:Int):CFFIPointer {
		return null;
	}
	...
	@:hlNative("lime", "hl_cairo_pattern_add_color_stop_rgb") private static function lime_cairo_pattern_add_color_stop_rgb(handle:CFFIPointer, offset:Float, red:Float, green:Float, blue:Float):Void {}

	@:hlNative("lime", "hl_cairo_pattern_add_color_stop_rgba") private static function lime_cairo_pattern_add_color_stop_rgba(handle:CFFIPointer, offset:Float, red:Float, green:Float, blue:Float, alpha:Float):Void {}
	...
	@:hlNative("lime", "hl_cairo_pattern_create_linear") private static function lime_cairo_pattern_create_linear(x0:Float, y0:Float, x1:Float, y1:Float):CFFIPointer {
		return null;
	}

	@:hlNative("lime", "hl_cairo_pattern_create_radial") private static function lime_cairo_pattern_create_radial(cx0:Float, cy0:Float, radius0:Float, cx1:Float, cy1:Float, radius1:Float):CFFIPointer {
		return null;
	}
	...
	private static var lime_curl_easy_duphandle = new cpp.Callable<cpp.Object -> cpp.Object>(cpp.Prime._loadPrime("lime", "lime_curl_easy_duphandle", "oo", false));
	private static var lime_curl_easy_escape = new cpp.Callable<cpp.Object -> String -> Int -> cpp.Object>(cpp.Prime._loadPrime("lime", "lime_curl_easy_escape", "osio", false));
	...
	private static var lime_curl_easy_getinfo = new cpp.Callable<cpp.Object -> Int -> cpp.Object>(cpp.Prime._loadPrime("lime", "lime_curl_easy_getinfo", "oio", false));
	...
	private static var lime_curl_easy_recv = new cpp.Callable<cpp.Object -> cpp.Object -> Int -> Int -> Int>(cpp.Prime._loadPrime("lime", "lime_curl_easy_recv", "ooiii", false));
	...
	private static var lime_curl_easy_send = new cpp.Callable<cpp.Object -> cpp.Object -> Int -> Int -> Int>(cpp.Prime._loadPrime("lime", "lime_curl_easy_send", "ooiii", false));
	private static var lime_curl_easy_setopt = new cpp.Callable<cpp.Object -> Int -> cpp.Object -> cpp.Object -> Int>(cpp.Prime._loadPrime("lime", "lime_curl_easy_setopt", "oiooi", false));
	...
	private static var lime_curl_easy_unescape = new cpp.Callable<cpp.Object -> String -> Int -> Int -> cpp.Object>(cpp.Prime._loadPrime("lime", "lime_curl_easy_unescape", "osiio", false));
	...
	private static var lime_curl_multi_add_handle = new cpp.Callable<cpp.Object -> cpp.Object -> cpp.Object -> Int>(cpp.Prime._loadPrime("lime", "lime_curl_multi_add_handle", "oooi", false));
	private static var lime_curl_multi_get_running_handles = new cpp.Callable<cpp.Object -> Int>(cpp.Prime._loadPrime("lime", "lime_curl_multi_get_running_handles", "oi", false));
	private static var lime_curl_multi_info_read = new cpp.Callable<cpp.Object -> cpp.Object>(cpp.Prime._loadPrime("lime", "lime_curl_multi_info_read", "oo", false));
	...
	private static var lime_curl_multi_remove_handle = new cpp.Callable<cpp.Object -> cpp.Object -> Int>(cpp.Prime._loadPrime("lime", "lime_curl_multi_remove_handle", "ooi", false));
	private static var lime_curl_multi_setopt = new cpp.Callable<cpp.Object -> Int -> cpp.Object -> Int>(cpp.Prime._loadPrime("lime", "lime_curl_multi_setopt", "oioi", false));
	...
	@:hlNative("lime", "hl_curl_easy_setopt") private static function lime_curl_easy_setopt(handle:CFFIPointer, option:Int, parameter:Dynamic, writeBytes:Bytes):Int {
		return 0;
	}
	...
	@:hlNative("lime", "hl_curl_easy_unescape") private static function lime_curl_easy_unescape(curl:CFFIPointer, url:String, inlength:Int, outlength:Int):hl.Bytes {
		return null;
	}
	...
	@:hlNative("lime", "hl_curl_multi_add_handle") private static function lime_curl_multi_add_handle(multi_handle:CFFIPointer, curl_object:Dynamic, curl_handle:CFFIPointer):Int {
		return 0;
	}
	...
	@:hlNative("lime", "hl_curl_multi_remove_handle") private static function lime_curl_multi_remove_handle(multi_handle:CFFIPointer, curl_handle:CFFIPointer):Int {
		return 0;
	}
	...
	private static var lime_gl_compressed_tex_image_3d = new cpp.Callable<Int -> Int -> Int -> Int -> Int -> Int -> Int -> Int -> lime.utils.DataPointer -> cpp.Void>(cpp.Prime._loadPrime("lime", "lime_gl_compressed_tex_image_3d", "iiiiiiiidv",
		false));
	private static var lime_gl_compressed_tex_sub_image_2d = new cpp.Callable<Int -> Int -> Int -> Int -> Int -> Int -> Int -> Int -> lime.utils.DataPointer -> cpp.Void>(cpp.Prime._loadPrime("lime", "lime_gl_compressed_tex_sub_image_2d",
		"iiiiiiiidv", false));
	private static var lime_gl_compressed_tex_sub_image_3d = new cpp.Callable<Int -> Int -> Int -> Int -> Int -> Int -> Int -> Int -> Int -> Int -> lime.utils.DataPointer -> cpp.Void>(cpp.Prime._loadPrime("lime",
		"lime_gl_compressed_tex_sub_image_3d", "iiiiiiiiiidv", false));
	...
	private static var lime_gl_tex_sub_image_3d = new cpp.Callable<Int -> Int -> Int -> Int -> Int -> Int -> Int -> Int -> Int -> Int -> lime.utils.DataPointer -> cpp.Void>(cpp.Prime._loadPrime("lime", "lime_gl_tex_sub_image_3d", "iiiiiiiiiidv",
		false));
	...
	@:hlNative("lime", "hl_gl_bind_buffer_range") private static function lime_gl_bind_buffer_range(target:Int, index:Int, buffer:Int, offset:DataPointer, size:Int):Void {}
	...
	@:hlNative("lime", "hl_gl_blend_func_separate") private static function lime_gl_blend_func_separate(srcRGB:Int, dstRGB:Int, srcAlpha:Int, dstAlpha:Int):Void {}

	@:hlNative("lime", "hl_gl_blit_framebuffer") private static function lime_gl_blit_framebuffer(srcX0:Int, srcY0:Int, srcX1:Int, srcY1:Int, dstX0:Int, dstY0:Int, dstX1:Int, dstY1:Int, mask:Int, filter:Int):Void {}
	...
	@:hlNative("lime", "hl_gl_compressed_tex_image_2d") private static function lime_gl_compressed_tex_image_2d(target:Int, level:Int, internalformat:Int, width:Int, height:Int, border:Int, imageSize:Int, data:DataPointer):Void {}

	@:hlNative("lime", "hl_gl_compressed_tex_image_3d") private static function lime_gl_compressed_tex_image_3d(target:Int, level:Int, internalformat:Int, width:Int, height:Int, depth:Int, border:Int, imageSize:Int, data:DataPointer):Void {}

	@:hlNative("lime", "hl_gl_compressed_tex_sub_image_2d") private static function lime_gl_compressed_tex_sub_image_2d(target:Int, level:Int, xoffset:Int, yoffset:Int, width:Int, height:Int, format:Int, imageSize:Int, data:DataPointer):Void {}

	@:hlNative("lime", "hl_gl_compressed_tex_sub_image_3d") private static function lime_gl_compressed_tex_sub_image_3d(target:Int, level:Int, xoffset:Int, yoffset:Int, zoffset:Int, width:Int, height:Int, depth:Int, format:Int, imageSize:Int,
		data:DataPointer):Void {}

	@:hlNative("lime", "hl_gl_copy_buffer_sub_data") private static function lime_gl_copy_buffer_sub_data(readTarget:Int, writeTarget:Int, readOffset:DataPointer, writeOffset:DataPointer, size:Int):Void {}

	@:hlNative("lime", "hl_gl_copy_tex_image_2d") private static function lime_gl_copy_tex_image_2d(target:Int, level:Int, internalformat:Int, x:Int, y:Int, width:Int, height:Int, border:Int):Void {}

	@:hlNative("lime", "hl_gl_copy_tex_sub_image_2d") private static function lime_gl_copy_tex_sub_image_2d(target:Int, level:Int, xoffset:Int, yoffset:Int, x:Int, y:Int, width:Int, height:Int):Void {}

	@:hlNative("lime", "hl_gl_copy_tex_sub_image_3d") private static function lime_gl_copy_tex_sub_image_3d(target:Int, level:Int, xoffset:Int, yoffset:Int, zoffset:Int, x:Int, y:Int, width:Int, height:Int):Void {}
	...
	@:hlNative("lime", "hl_gl_draw_arrays_instanced") private static function lime_gl_draw_arrays_instanced(mode:Int, first:Int, count:Int, instanceCount:Int):Void {}
	...
	@:hlNative("lime", "hl_gl_draw_elements_instanced") private static function lime_gl_draw_elements_instanced(mode:Int, count:Int, type:Int, offset:DataPointer, instanceCount:Int):Void {}

	@:hlNative("lime", "hl_gl_draw_range_elements") private static function lime_gl_draw_range_elements(mode:Int, start:Int, end:Int, count:Int, type:Int, offset:DataPointer):Void {}
	...
	@:hlNative("lime", "hl_gl_framebuffer_renderbuffer") private static function lime_gl_framebuffer_renderbuffer(target:Int, attachment:Int, renderbuffertarget:Int, renderbuffer:Int):Void {}

	@:hlNative("lime", "hl_gl_framebuffer_texture2D") private static function lime_gl_framebuffer_texture2D(target:Int, attachment:Int, textarget:Int, texture:Int, level:Int):Void {}

	@:hlNative("lime", "hl_gl_framebuffer_texture_layer") private static function lime_gl_framebuffer_texture_layer(target:Int, attachment:Int, texture:Int, level:Int, layer:Int):Void {}
	...
	@:hlNative("lime", "hl_gl_get_active_uniform_blocki") private static function lime_gl_get_active_uniform_blocki(program:Int, uniformBlockIndex:Int, pname:Int):Int {
		return 0;
	}

	@:hlNative("lime", "hl_gl_get_active_uniform_blockiv") private static function lime_gl_get_active_uniform_blockiv(program:Int, uniformBlockIndex:Int, pname:Int, params:DataPointer):Void {}

	@:hlNative("lime", "hl_gl_get_active_uniform_block_name") private static function lime_gl_get_active_uniform_block_name(program:Int, uniformBlockIndex:Int):hl.Bytes {
		return null;
	}

	@:hlNative("lime", "hl_gl_get_active_uniformsiv") private static function lime_gl_get_active_uniformsiv(program:Int, uniformIndices:hl.NativeArray<Int>, pname:Int, params:DataPointer):Void {}
	...
	@:hlNative("lime", "hl_gl_get_buffer_parameteri64v") private static function lime_gl_get_buffer_parameteri64v(target:Int, index:Int, params:DataPointer):Void {}
	...
	@:hlNative("lime", "hl_gl_get_framebuffer_attachment_parameteri") private static function lime_gl_get_framebuffer_attachment_parameteri(target:Int, attachment:Int, pname:Int):Int {
		return 0;
	}
	...
	@:hlNative("lime", "hl_gl_get_internalformativ") private static function lime_gl_get_internalformativ(target:Int, internalformat:Int, pname:Int, bufSize:Int, params:DataPointer):Void {}
	...
	@:hlNative("lime", "hl_gl_get_renderbuffer_parameteriv") private static function lime_gl_get_renderbuffer_parameteriv(target:Int, pname:Int, params:DataPointer):Void {}
	...
	@:hlNative("lime", "hl_gl_get_shader_precision_format") private static function lime_gl_get_shader_precision_format(shadertype:Int, precisiontype:Int):Dynamic {
		return null;
	}
	...
	@:hlNative("lime", "hl_gl_get_sync_parameteriv") private static function lime_gl_get_sync_parameteriv(sync:CFFIPointer, pname:Int, params:DataPointer):Void {}
	...
	@:hlNative("lime", "hl_gl_invalidate_framebuffer") private static function lime_gl_invalidate_framebuffer(target:Int, attachments:hl.NativeArray<Int>):Void {}

	@:hlNative("lime", "hl_gl_invalidate_sub_framebuffer") private static function lime_gl_invalidate_sub_framebuffer(target:Int, attachments:hl.NativeArray<Int>, x:Int, y:Int, width:Int, height:Int):Void {}
	...
	@:hlNative("lime", "hl_gl_map_buffer_range") private static function lime_gl_map_buffer_range(target:Int, offset:DataPointer, length:Int, access:Int):DataPointer {
		return 0;
	}
	...
	@:hlNative("lime", "hl_gl_program_binary") private static function lime_gl_program_binary(program:Int, binaryFormat:Int, binary:DataPointer, length:Int):Void {}
	...
	@:hlNative("lime", "hl_gl_read_pixels") private static function lime_gl_read_pixels(x:Int, y:Int, width:Int, height:Int, format:Int, type:Int, pixels:DataPointer):Void {}

	@:hlNative("lime", "hl_gl_release_shader_compiler") private static function lime_gl_release_shader_compiler():Void {}

	@:hlNative("lime", "hl_gl_renderbuffer_storage") private static function lime_gl_renderbuffer_storage(target:Int, internalformat:Int, width:Int, height:Int):Void {}

	@:hlNative("lime", "hl_gl_renderbuffer_storage_multisample") private static function lime_gl_renderbuffer_storage_multisample(target:Int, samples:Int, internalformat:Int, width:Int, height:Int):Void {}
	...
	@:hlNative("lime", "hl_gl_shader_binary") private static function lime_gl_shader_binary(shaders:hl.NativeArray<Int>, binaryformat:Int, binary:DataPointer, length:Int):Void {}
	...
	@:hlNative("lime", "hl_gl_tex_image_2d") private static function lime_gl_tex_image_2d(target:Int, level:Int, internalformat:Int, width:Int, height:Int, border:Int, format:Int, type:Int, data:DataPointer):Void {}

	@:hlNative("lime", "hl_gl_tex_image_3d") private static function lime_gl_tex_image_3d(target:Int, level:Int, internalformat:Int, width:Int, height:Int, depth:Int, border:Int, format:Int, type:Int, data:DataPointer):Void {}
	...
	@:hlNative("lime", "hl_gl_tex_storage_2d") private static function lime_gl_tex_storage_2d(target:Int, level:Int, internalformat:Int, width:Int, height:Int):Void {}

	@:hlNative("lime", "hl_gl_tex_storage_3d") private static function lime_gl_tex_storage_3d(target:Int, level:Int, internalformat:Int, width:Int, height:Int, depth:Int):Void {}
	...
	@:hlNative("lime", "hl_gl_tex_sub_image_3d") private static function lime_gl_tex_sub_image_3d(target:Int, level:Int, xoffset:Int, yoffset:Int, zoffset:Int, width:Int, height:Int, depth:Int, format:Int, type:Int, data:DataPointer):Void {}

	@:hlNative("lime", "hl_gl_transform_feedback_varyings") private static function lime_gl_transform_feedback_varyings(program:Int, varyings:hl.NativeArray<Int>, bufferMode:Int):Void {}
	...
	@:hlNative("lime", "hl_gl_uniform_block_binding") private static function lime_gl_uniform_block_binding(program:Int, uniformBlockIndex:Int, uniformBlockBinding:Int):Void {}

	@:hlNative("lime", "hl_gl_uniform_matrix2fv") private static function lime_gl_uniform_matrix2fv(location:Int, count:Int, transpose:Bool, value:DataPointer):Void {}

	@:hlNative("lime", "hl_gl_uniform_matrix2x3fv") private static function lime_gl_uniform_matrix2x3fv(location:Int, count:Int, transpose:Bool, value:DataPointer):Void {}

	@:hlNative("lime", "hl_gl_uniform_matrix2x4fv") private static function lime_gl_uniform_matrix2x4fv(location:Int, count:Int, transpose:Bool, value:DataPointer):Void {}

	@:hlNative("lime", "hl_gl_uniform_matrix3fv") private static function lime_gl_uniform_matrix3fv(location:Int, count:Int, transpose:Bool, value:DataPointer):Void {}

	@:hlNative("lime", "hl_gl_uniform_matrix3x2fv") private static function lime_gl_uniform_matrix3x2fv(location:Int, count:Int, transpose:Bool, value:DataPointer):Void {}

	@:hlNative("lime", "hl_gl_uniform_matrix3x4fv") private static function lime_gl_uniform_matrix3x4fv(location:Int, count:Int, transpose:Bool, value:DataPointer):Void {}

	@:hlNative("lime", "hl_gl_uniform_matrix4fv") private static function lime_gl_uniform_matrix4fv(location:Int, count:Int, transpose:Bool, value:DataPointer):Void {}

	@:hlNative("lime", "hl_gl_uniform_matrix4x2fv") private static function lime_gl_uniform_matrix4x2fv(location:Int, count:Int, transpose:Bool, value:DataPointer):Void {}

	@:hlNative("lime", "hl_gl_uniform_matrix4x3fv") private static function lime_gl_uniform_matrix4x3fv(location:Int, count:Int, transpose:Bool, value:DataPointer):Void {}
	...
	@:hlNative("lime", "hl_gl_vertex_attrib_ipointer") private static function lime_gl_vertex_attrib_ipointer(indx:Int, size:Int, type:Int, stride:Int, offset:DataPointer):Void {}

	@:hlNative("lime", "hl_gl_vertex_attrib_pointer") private static function lime_gl_vertex_attrib_pointer(indx:Int, size:Int, type:Int, normalized:Bool, stride:Int, offset:DataPointer):Void {}
	...
	@:hlNative("lime", "hl_hb_blob_create_sub_blob") private static function lime_hb_blob_create_sub_blob(parent:CFFIPointer, offset:Int, length:Int):CFFIPointer {
		return null;
	}
	...
	@:hlNative("lime", "hl_hb_buffer_add_codepoints") private static function lime_hb_buffer_add_codepoints(buffer:CFFIPointer, text:DataPointer, textLength:Int, itemOffset:Int, itemLength:Int):Void {}

	@:hlNative("lime", "hl_hb_buffer_add_utf8") private static function lime_hb_buffer_add_utf8(buffer:CFFIPointer, text:String, itemOffset:Int, itemLength:Int):Void {}

	@:hlNative("lime", "hl_hb_buffer_add_utf16") private static function lime_hb_buffer_add_utf16(buffer:CFFIPointer, text:DataPointer, textLength:Int, itemOffset:Int, itemLength:Int):Void {}

	@:hlNative("lime", "hl_hb_buffer_add_utf32") private static function lime_hb_buffer_add_utf32(buffer:CFFIPointer, text:DataPointer, textLength:Int, itemOffset:Int, itemLength:Int):Void {}
	...
	@:hlNative("lime", "hl_hb_buffer_get_segment_properties") private static function lime_hb_buffer_get_segment_properties(buffer:CFFIPointer, props:CFFIPointer):Void {}
	...
	@:hlNative("lime", "hl_hb_buffer_set_replacement_codepoint") private static function lime_hb_buffer_set_replacement_codepoint(buffer:CFFIPointer, replacement:Int):Void {}
	...
	@:hlNative("lime", "hl_hb_buffer_set_segment_properties") private static function lime_hb_buffer_set_segment_properties(buffer:CFFIPointer, props:CFFIPointer):Void {}
	...
	@:hlNative("lime", "hl_hb_font_add_glyph_origin_for_direction") private static function lime_hb_font_add_glyph_origin_for_direction(font:CFFIPointer, glyph:Int, direction:Int, x:Int, y:Int):Void {}
	...
	@:hlNative("lime", "hl_hb_font_get_glyph_advance_for_direction") private static function lime_hb_font_get_glyph_advance_for_direction(font:CFFIPointer, glyph:Int, direction:Int, out:Vector2):Vector2 {
		return null;
	}

	@:hlNative("lime", "hl_hb_font_get_glyph_kerning_for_direction") private static function lime_hb_font_get_glyph_kerning_for_direction(font:CFFIPointer, firstGlyph:Int, secondGlyph:Int, direction:Int, out:Vector2):Vector2 {
		return null;
	}

	@:hlNative("lime", "hl_hb_font_get_glyph_origin_for_direction") private static function lime_hb_font_get_glyph_origin_for_direction(font:CFFIPointer, glyph:Int, direction:Int, out:Vector2):Vector2 {
		return null;
	}
	...
	@:hlNative("lime", "hl_hb_font_subtract_glyph_origin_for_direction") private static function lime_hb_font_subtract_glyph_origin_for_direction(font:CFFIPointer, glyph:Int, direction:Int, x:Int, y:Int):Void {}
	...
	#else
	private static var lime_vorbis_file_bitrate = new cpp.Callable<cpp.Object -> Int -> Int>(cpp.Prime._loadPrime("lime", "lime_vorbis_file_bitrate", "oii", false));
	private static var lime_vorbis_file_bitrate_instant = new cpp.Callable<cpp.Object -> Int>(cpp.Prime._loadPrime("lime", "lime_vorbis_file_bitrate_instant", "oi", false));
	...
	private static var lime_vorbis_file_comment = new cpp.Callable<cpp.Object -> Int -> cpp.Object>(cpp.Prime._loadPrime("lime", "lime_vorbis_file_comment", "oio", false));
	private static var lime_vorbis_file_crosslap = new cpp.Callable<cpp.Object -> cpp.Object -> cpp.Object>(cpp.Prime._loadPrime("lime", "lime_vorbis_file_crosslap", "ooo", false));
	private static var lime_vorbis_file_from_bytes = new cpp.Callable<cpp.Object -> cpp.Object>(cpp.Prime._loadPrime("lime", "lime_vorbis_file_from_bytes", "oo", false));
	private static var lime_vorbis_file_from_file = new cpp.Callable<String -> cpp.Object>(cpp.Prime._loadPrime("lime", "lime_vorbis_file_from_file", "so", false));
	private static var lime_vorbis_file_info = new cpp.Callable<cpp.Object -> Int -> cpp.Object>(cpp.Prime._loadPrime("lime", "lime_vorbis_file_info", "oio", false));
	private static var lime_vorbis_file_pcm_seek = new cpp.Callable<cpp.Object -> cpp.Object -> cpp.Object -> Int>(cpp.Prime._loadPrime("lime", "lime_vorbis_file_pcm_seek", "oooi", false));
	private static var lime_vorbis_file_pcm_seek_lap = new cpp.Callable<cpp.Object -> cpp.Object -> cpp.Object -> Int>(cpp.Prime._loadPrime("lime", "lime_vorbis_file_pcm_seek_lap", "oooi", false));
	private static var lime_vorbis_file_pcm_seek_page = new cpp.Callable<cpp.Object -> cpp.Object -> cpp.Object -> Int>(cpp.Prime._loadPrime("lime", "lime_vorbis_file_pcm_seek_page", "oooi", false));
	private static var lime_vorbis_file_pcm_seek_page_lap = new cpp.Callable<cpp.Object -> cpp.Object -> cpp.Object -> Int>(cpp.Prime._loadPrime("lime", "lime_vorbis_file_pcm_seek_page_lap", "oooi", false));
	private static var lime_vorbis_file_raw_seek = new cpp.Callable<cpp.Object -> cpp.Object -> cpp.Object -> Int>(cpp.Prime._loadPrime("lime", "lime_vorbis_file_raw_seek", "oooi", false));
	private static var lime_vorbis_file_raw_seek_lap = new cpp.Callable<cpp.Object -> cpp.Object -> cpp.Object -> Int>(cpp.Prime._loadPrime("lime", "lime_vorbis_file_raw_seek_lap", "oooi", false));
	private static var lime_vorbis_file_pcm_tell = new cpp.Callable<cpp.Object -> cpp.Object>(cpp.Prime._loadPrime("lime", "lime_vorbis_file_pcm_tell", "oo", false));
	private static var lime_vorbis_file_pcm_total = new cpp.Callable<cpp.Object -> Int -> cpp.Object>(cpp.Prime._loadPrime("lime", "lime_vorbis_file_pcm_total", "oio", false));
	private static var lime_vorbis_file_raw_tell = new cpp.Callable<cpp.Object -> cpp.Object>(cpp.Prime._loadPrime("lime", "lime_vorbis_file_raw_tell", "oo", false));
	private static var lime_vorbis_file_raw_total = new cpp.Callable<cpp.Object -> Int -> cpp.Object>(cpp.Prime._loadPrime("lime", "lime_vorbis_file_raw_total", "oio", false));
	private static var lime_vorbis_file_read = new cpp.Callable<cpp.Object -> cpp.Object -> Int -> Int -> Bool -> Int -> Bool -> cpp.Object>(cpp.Prime._loadPrime("lime", "lime_vorbis_file_read", "ooiibibo", false));
	private static var lime_vorbis_file_read_float = new cpp.Callable<cpp.Object -> cpp.Object -> Int -> cpp.Object>(cpp.Prime._loadPrime("lime", "lime_vorbis_file_read_float", "ooio", false));
	...
	private static var lime_vorbis_file_serial_number = new cpp.Callable<cpp.Object -> Int -> Int>(cpp.Prime._loadPrime("lime", "lime_vorbis_file_serial_number", "oii", false));
	...
	private static var lime_vorbis_file_time_seek = new cpp.Callable<cpp.Object -> Float -> Int>(cpp.Prime._loadPrime("lime", "lime_vorbis_file_time_seek", "odi", false));
	private static var lime_vorbis_file_time_seek_lap = new cpp.Callable<cpp.Object -> Float -> Int>(cpp.Prime._loadPrime("lime", "lime_vorbis_file_time_seek_lap", "odi", false));
	private static var lime_vorbis_file_time_seek_page = new cpp.Callable<cpp.Object -> Float -> Int>(cpp.Prime._loadPrime("lime", "lime_vorbis_file_time_seek_page", "odi", false));
	private static var lime_vorbis_file_time_seek_page_lap = new cpp.Callable<cpp.Object -> Float -> Int>(cpp.Prime._loadPrime("lime", "lime_vorbis_file_time_seek_page_lap", "odi", false));
	private static var lime_vorbis_file_time_tell = new cpp.Callable<cpp.Object -> Float>(cpp.Prime._loadPrime("lime", "lime_vorbis_file_time_tell", "od", false));
	private static var lime_vorbis_file_time_total = new cpp.Callable<cpp.Object -> Int -> Float>(cpp.Prime._loadPrime("lime", "lime_vorbis_file_time_total", "oid", false));
	#end
	#end
	#if (neko || cppia)
	...
	@:hlNative("lime", "hl_vorbis_file_pcm_seek_page") private static function lime_vorbis_file_pcm_seek_page(vorbisFile:CFFIPointer, posLow:Int, posHigh:Int):Int {
		return 0;
	}

	@:hlNative("lime", "hl_vorbis_file_pcm_seek_page_lap") private static function lime_vorbis_file_pcm_seek_page_lap(vorbisFile:CFFIPointer, posLow:Int, posHigh:Int):Int {
		return 0;
	}
	...
	@:hlNative("lime", "hl_vorbis_file_read") private static function lime_vorbis_file_read(vorbisFile:CFFIPointer, buffer:Bytes, position:Int, length:Int, bigendianp:Bool, word:Int, signed:Bool):Dynamic {
		return null;
	}

	@:hlNative("lime", "hl_vorbis_file_read_float") private static function lime_vorbis_file_read_float(vorbisFile:CFFIPointer, pcmChannels:Bytes, samples:Int):Dynamic {
		return null;
	}
